...
class AdminDashboardView(LoginRequiredMixin, View):
    def get(self, request, *args, **kwargs):
        return render(request, 'e_commerce/admin_dashboard.html', {'user': request.user})

class VendorDashboardView(LoginRequiredMixin, View):
    def get(self, request, *args, **kwargs):
        return render(request, 'e_commerce/vendor_dashboard.html', {'user': request.user})

class CustomerDashboardView(LoginRequiredMixin, View):
    def get(self, request, *args, **kwargs):
        return render(request, 'e_commerce/customer_dashboard.html', {'user': request.user})

class ErrorView(View):
    def get(self, request, *args, **kwargs):
        return render(request, 'e_commerce/error404.html', {'message': 'Unauthorized access.'})
